...
semgrep: scope: modified since 2026-09-25 00:00 (from "昨日")
...
- **変更時期**: 変更を表す動詞と並んだ日付や期間。「昨日変えた」「先週追加した」「9月20日以降に修正した」
  「ここ 3 日でコミットした」「changed yesterday」。その時期に変えたファイルは、その時刻以降に更新されています。
  更新時刻はそれ以上のことを言えません (後で変えれば動くため)。行の内容が話している日付 (「9月20日のリリース」
